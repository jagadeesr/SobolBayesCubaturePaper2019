...
\nonumber
& = \Big((-1)^{\ai^T \aj)} \Big)_{i,j=0}^{2^m-1}.
\end{align}
where $\bigotimes$ is Kronecker product, and $\ai^T \aj = i_0 j_0 + i_1 j_1 +\cdots$. Note that the Walsh-Hadamard matrices are symmetric.
